let s:tc = unittest#testcase#new('autoload/unite/sources/giti/branch.vim',
...
\   type([]),
\   type(unite#sources#giti#branch#define()),
\ )
  call self.assert_throw('E118', 'call self.call("unite#sources#giti#branch#define", [""])')
endfunction"}}}
...
function! s:tc.source_should_have()"{{{
  ...
  call self.assert(type(function('tr')), type(source.change_candidates))
endfunction"}}}
